function Find-ADObject {
	...
	.LINK
		Github Link	- https://raw.githubusercontent.com/CtrlAltDrink/pwsh/refs/heads/zero/functions/function-Find-ADObject.ps1
	...
	.NOTES
		Created by:	https://github.com/CtrlAltDrink
	#>
	[CmdletBinding()]
	param (
	...
	try {
		...
		Write-Error $Error[0]
		Write-Warning "Check your network or vpn connection";pause;return
	}
    ...
    $Object.CanonicalName = $Object.CanonicalName -replace '/',' ▶ '
